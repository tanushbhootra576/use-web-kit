export const metadata = {
  title: "useSharedWorkerPool — use-web-kit",
  description: "Enterprise multi-tab sync and offloading using a single SharedWorker.",
};
...
{`function useSharedWorkerPool<TIn, TOut>(options: UseSharedWorkerPoolOptions): UseSharedWorkerPoolReturn<TIn, TOut>`}
          </pre>
        </div>
      </div>
...
const { postMessage, broadcast } = useSharedWorkerPool({ workerUrl: "/socket-worker.js" });`}
          </pre>
        </div>
      </div>
