export const metadata = {
  title: "useElementDimensions — use-web-kit",
  description: "O(1) DOM measurement hook using a module-level ResizeObserver singleton.",
};
...
{`function useElementDimensions(): { ref, dimensions }`}
          </pre>
        </div>
      </div>
